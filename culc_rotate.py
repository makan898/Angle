###参考 https://qiita.com/grouse324/items/74988134a9073568b32d

#culc_rotateに二枚の画像を渡すと回転角度を返します
#特徴点マッチングを使用しているので、余計なものの映り込みや形態の変化には弱いです
#逆に、それらがない場合はかなり正確です
...
def culc_rotate(query_img,map_img):
    ...
    if len(good) <= 1:
        ...
        point_num = 5  # 上位何個の点をマッチングに使うか（重要パラメータ）
...
def vote_point(query_kp, map_kp, point_num):
    ...
    size_range_min = 0.03  # 明らかに違う比率の結果を弾く重要パラメータ
